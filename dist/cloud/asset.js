...
var S3Signer = exports.S3Signer = function (_Signer3) {
  ...
  function S3Signer(_settings) {
    ...
    var prefix = _this5.assetStoreS3URLPrefix;
    var host = void 0;
    var bucket = void 0;
    if (prefix) {
      var parsed = _url2.default.parse(prefix);
      host = parsed.host;
      bucket = parsed.pathname;
    } else {
      var region = _this5.assetStoreS3Region;
      host = 's3-' + region + '.amazonaws.com';
      bucket = _this5.assetStoreS3Bucket;
    }
  ...
  _createClass(S3Signer, [{
    ...
    value: function sign(name) {
      var duration = this.assetStoreURLExpireDuration;
      var url = this.signer.getUrl('GET', name, this.bucket, duration);
